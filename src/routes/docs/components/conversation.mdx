...
<TypeTable
  type={{
    ...
    children: {
      description: 'Render prop or JSX.Element for custom rendering with context.',
      type: '((context: StickToBottomContext) => JSX.Element) | JSX.Element',
    },
    '...props': {
      description: 'Any other props are spread to the root div.',
      type: 'Omit<JSX.HTMLAttributes<HTMLDivElement>, "children">',
    },
  }}
/>
