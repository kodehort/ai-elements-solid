...
export type OpenInProps = ParentProps<
  Parameters<typeof DropdownMenu>[0] & { query: string }
>;

export function OpenIn(props: OpenInProps) {
  const [local, others] = splitProps(props, ["query", "children"]);

  return (
    <OpenInContext.Provider value={{ query: local.query }}>
      <DropdownMenu {...others}>{local.children}</DropdownMenu>
    </OpenInContext.Provider>
  );
}

export type OpenInContentProps = Parameters<typeof DropdownMenuContent>[0];

export function OpenInContent(props: OpenInContentProps) {
  const [local, others] = splitProps(props, ["class"]);

  return (
    <DropdownMenuContent class={cn("w-[240px]", local.class)} {...others} />
  );
}

export type OpenInItemProps = Parameters<typeof DropdownMenuItem>[0];

export function OpenInItem(props: OpenInItemProps) {
  return <DropdownMenuItem {...props} />;
}

export type OpenInLabelProps = Parameters<typeof DropdownMenuLabel>[0];

export function OpenInLabel(props: OpenInLabelProps) {
  return <DropdownMenuLabel {...props} />;
}

export type OpenInSeparatorProps = Parameters<typeof DropdownMenuSeparator>[0];

export function OpenInSeparator(props: OpenInSeparatorProps) {
  return <DropdownMenuSeparator {...props} />;
}

export type OpenInTriggerProps = ParentProps<
...
export type OpenInChatGPTProps = Parameters<typeof DropdownMenuItem>[0];
  ...
  return (
    <DropdownMenuItem {...props}>
      <a
        ...
        target="_blank"
      >
        <span class="size-4 shrink-0">{providers.chatgpt.icon}</span>
...
export type OpenInClaudeProps = Parameters<typeof DropdownMenuItem>[0];
  ...
  return (
    <DropdownMenuItem {...props}>
      <a
        ...
        target="_blank"
      >
        <span class="size-4 shrink-0">{providers.claude.icon}</span>
...
export type OpenInT3Props = Parameters<typeof DropdownMenuItem>[0];
  ...
  return (
    <DropdownMenuItem {...props}>
      <a
        ...
        target="_blank"
      >
        <span class="size-4 shrink-0">{providers.t3.icon}</span>
...
export type OpenInSciraProps = Parameters<typeof DropdownMenuItem>[0];
  ...
  return (
    <DropdownMenuItem {...props}>
      <a
        ...
        target="_blank"
      >
        <span class="size-4 shrink-0">{providers.scira.icon}</span>
...
export type OpenInv0Props = Parameters<typeof DropdownMenuItem>[0];
  ...
  return (
    <DropdownMenuItem {...props}>
      <a
        ...
        target="_blank"
      >
        <span class="size-4 shrink-0">{providers.v0.icon}</span>
...
export type OpenInCursorProps = Parameters<typeof DropdownMenuItem>[0];
  ...
  return (
    <DropdownMenuItem {...props}>
      <a
        ...
        target="_blank"
      >
        <span class="size-4 shrink-0">{providers.cursor.icon}</span>
        <span class="flex-1">{providers.cursor.title}</span>
        <ExternalLink class="size-4 shrink-0" />
      </a>
    </DropdownMenuItem>
  );
